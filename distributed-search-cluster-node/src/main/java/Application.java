...
public class Application implements Watcher {
    private static final String ZOOKEEPER_ADDRESS = "zoo1:2181";
    ...
    public static void main(String[] args) throws IOException, InterruptedException, KeeperException {
        ...
        ServiceRegistry electionZnodeRegistry = new ServiceRegistry(zooKeeper, ServiceRegistry.ELECTION_REGISTRY_ZNODE);
